    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button 
          variant="ghost" 
          size="icon" 
                        className="h-9 w-9 rounded-none hover:bg-primary/30"
        >
          <HelpCircle className="h-7 w-7 stroke-[3]" />
        </Button>
      </DialogTrigger>
              <DialogContent className="border-1 border-black rounded-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] bg-secondary">
        <DialogHeader>
