    ...
    <Layout>
      <div className="min-h-screen bg-background-secondary dark:bg-background">
        ...
        <main className="max-w-4xl mx-auto px-4">
          <div className="bg-background dark:bg-background border border-border dark:border-border rounded-lg p-8 shadow-sm">
            <div className="text-lg text-foreground-muted dark:text-foreground-muted leading-relaxed">
              <p>
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Acceptance of Terms</h2>
              <p>
                <br />
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Description of Service</h2>
              <br />
              <p>
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">User Accounts & Data</h2>
              <p>
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Acceptable Use</h2>
              <p>
                  You agree NOT to:
              </p>
              <ul>
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Privacy</h2>
              <br />
              <p>
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Third-Party Links & Dependencies</h2>
              <p>
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Disclaimer of Warranties</h2>
              <p>
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Limitation of Liability</h2>
              <p>
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Termination</h2>
              <p>
              We may suspend or terminate your access at any time, with or without
                  cause or notice. Sections 6–9 survive termination.
              </p>
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Governing Law & Dispute Resolution</h2>
              <p>
              ...
              <br />
              <h2 className="text-2xl font-bold text-foreground dark:text-foreground">Contact</h2>
              <p>
